...
<html lang="en">
  <head>
    ...
    <title>Welcome to Hostel Booking</title>
...
<!-- End WOWSlider.com HEAD section -->
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Hostel Booking</a>
...
<div class="ws_images"><ul>
		<li><a href="http://wowslider.com/vi"><img src="data1/images/1.jpg" alt="bootstrap slider" title="1" id="wows1_0"/></a></li>
...
<!-- End WOWSlider.com BODY section -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Search Hostel or homes for hire.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Desing by <b>samant and saif</b></span>
          </div>
          <div class="col-md-4">
